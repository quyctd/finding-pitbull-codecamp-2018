...
class PlayerDeath(GameObject):
    def __init__(self, x, y, frame_delay=1):
        ...
        self.renderer = Animation(["Scene2/image/player/player1.png",
                                   "Scene2/image/player/playerDeath1.png",
                                   "Scene2/image/player/playerDeath2.png",
                                   "Scene2/image/player/playerDeath3.png"])
